...
def grah_show(agent, agent_type, generator_centor, track, rank):
    ...
    ax1.scatter(*generator_centor, color="orange", s=50, zorder=3, label="Center of data generating distribution")
    ...
    ax2.scatter(*agent.estimate_center[0], color="red", s=50, zorder=4, label="The final mean estimate")
    ax2.scatter(*generator_centor, color="orange", s=50, zorder=3, label="Center of data generating distribution")
